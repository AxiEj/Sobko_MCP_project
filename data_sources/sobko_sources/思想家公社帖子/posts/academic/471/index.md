...
url: http://sobereva.com/471
date: '2019-03-16T10:27:00+08:00'
source_categories:
- Multiwfn
...
classification_reason: 标题是 Multiwfn 支持的化学键分析方法总览，属于软件功能综述。
topic_family: 软件
exclude_reason: ''
confidence: 0.98
image_count: 0
...
First release: 2019-Mar-19  Last update: 2025-Mar-6
...
另外，关于这些分析方法的原理、细节、特点以及在Multiwfn中的使用技巧，笔者会在北京科音每年都举办的“量子化学波函数分析与Multiwfn程序培训班”（<http://www.keinsci.com/workshop/WFN_content.html>）里非常深入、系统、全面地教授，并给出大量实际例子，十分推荐大家参加。读者还可以下载<http://sobereva.com/167>里提到的迄今用Multiwfn发表的海量论文的pdf合集，本文提到的大多数研究方法都已被其中的很多文章利用，可以将这里面的文章当例子库用。
...
**• 键级的分解分析**  
Multiwfn的键级计算功能绝不仅仅是计算出键级数值那么简单，Multiwfn可以将Mayer键级和Mulliken键级分解成轨道的贡献，前者也叫作“占据数扰动的Mayer键级”分析，见手册4.9.1节和4.9.5节的实例。如果做分解前先做轨道定域化，那么可以直接得到各个成键轨道对键级的影响，这在讨论实际化学键时往往特别有用，在<http://sobereva.com/380>的例子中利用到了这点。
