---
post_id: 663
title: 使用了Multiwfn发表的第11001~12000篇文章打包下载
url: http://sobereva.com/663
date: '2023-04-10T17:18:00+08:00'
source_categories:
- 量子化学
...
classification_reason: 内容是Multiwfn相关论文合集下载，属于资源整理。
topic_family: 资源经验
exclude_reason: ''
confidence: 0.92
image_count: 0
...
下面是第**11001~12000**篇使用了笔者开发的功能非常全面而且在世界范围流行的Multiwfn波函数分析程序（<http://sobereva.com/multiwfn>）发表的文章的全文pdf合集（其中漏了几篇文章对应的文件，不好找了）。

**阿里网盘（速度很快。各个pdf单文件上传）：<https://www.aliyundrive.com/s/uazRZnDwbJ1>  提取码: q36a**

**百度网盘下载地址（速度慢。所有pdf分卷压缩）：****https://pan.baidu.com/s/1kjP6bEkooUWxmSvaibov2Q?pwd=aie7**

这些文章的列表见文件包里的full list.txt，或者看<http://sobereva.com/multiwfn/all_citation3.html>里面的第11001~12000号文章。
...
**再次顺带强调关于恰当引用的问题**。在Multiwfn程序主页的Download页面、程序手册、程序启动时屏幕上显示的信息、程序包内的诸多文件（Multiwfn quick start.pdf文档、How to cite Multiwfn.pdf文档、LICENSE.txt文件）、Multiwfn入门贴（<http://sobereva.com/167>）、Multiwfn FAQ（<http://sobereva.com/452>）等尽可能多、用户可以轻易看到的所有地方都非常非常非常明确强调如何对Multiwfn进行正确的引用，但使用Multiwfn的文章中不引用或者胡乱引用的现象依然十分严重（特别是中国的文章尤甚）！第11001~12000篇文章里没按要求恰当引用Multiwfn的文章多达**132篇**。经常是只提及Multiwfn但不引用，甚至在引用Multiwfn的地方引用的却是和Multiwfn根本没有任何直接联系的其他人的文章。还有不少文章里作者明明在研究中用了Multiwfn做分析，在论文里竟然连Multiwfn的名字都不提。不按明确声明的方式恰当引用，对免费而且没有任何经费支持的程序的发展十分不利，同时也是严重缺乏学术道德的行为。借此机会再次强烈呼吁用户重视对Multiwfn的恰当引用。最恰当的引用方式见Multiwfn可执行文件包内的How to cite Multiwfn.pdf文档的说明。没有恰当引用Multiwfn的文章在本次的文件包里的full list.txt里都已经注上了Multiwfn was not properly cited!的字样，在此予以强烈批评。

另：**第8届“量子化学波函数分析与Multiwfn培训班”预计于2023年7月21-25日于北京举办**，非常欢迎大家参加！预计报名于7月初在北京科音官网<http://www.keinsci.com>开始，请注意关注（推荐订阅“北京科音”微信公众号，及时收到培训报名的提醒）。此培训是最难得的一次性系统性学通各种量子化学波函数分析知识、全面掌握强大的Multiwfn的各种功能使用的最佳机会！培训介绍见<http://www.keinsci.com/workshop/WFN_content.html>
