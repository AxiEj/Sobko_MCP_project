---
thread_id: 17494
source_id: forum_thread:17494
title: "使用Shermo结合量子化学程序方便地计算分子的各种热力学数据"
url: http://bbs.keinsci.com/thread-17494-1-1.html
...
source_crawled_at: "2026-06-05T11:14:28.176Z"
original_reply_count: 106
page_count: 8
views: 135792
software_tags:
- CP2K
...
authority_level: A
confidence: 0.97
classification_reason: sobereva原创Shermo工具教程，13.5万浏览，讲解使用Shermo结合量子化学程序计算热力学数据。
---

# 使用Shermo结合量子化学程序方便地计算分子的各种热力学数据

- 原帖 URL：<http://bbs.keinsci.com/thread-17494-1-1.html>
- 论坛板块：量子化学
- 作者：**sobereva**
- 浏览量：135792 | 回复数：106 | 共8页
- 完整性：**全部内容已完整抓取**。
...
使用Shermo结合量子化学程序方便地计算分子的各种热力学数据Using Shermo combined with quantum chemistry programs to conveniently calculate various thermodynamic data



文/Sobereva@北京科音First release: 2020-May-19  Last update: 2025-Jun-18
...
Shermo-A general code for calculating molecular thermochemistry properties.pdf

(1.87 MB, 下载次数 Times of downloads: 401)



2021-4-28 00:13 上传 Uploaded
点击下载
Click to download
...
接下来程序分别输出了体系整体平动、整体转动、分子内振动和电子激发各自对内能(U)、焓(H)、熵(S)、自由能(G)、等容热容(CV)、等压热容(CP)和配分函数(q)的贡献。输出的格式紧凑、内容非常清晰易读，还用了多种单位输出以方便用户。只要你仔细看过Shermo手册的附录，或者参加过北京科音的初级或中级量子化学教程（见http://sobereva.com/355）并仔细复习过，就肯定能轻易看懂这些信息，所以我就不再多说了。CV和CP的差异，以及H与U的差异仅来自于平动的贡献，因此只有平动部分是将它们分别输出的。
...
1.png (56.38 KB, 下载次数 Times of downloads: 505)

下载附件 Download



2020-5-19 03:44 上传 Uploaded
...
2.jpg (57.7 KB, 下载次数 Times of downloads: 558)

下载附件 Download



2020-5-19 03:43 上传 Uploaded
...
A：然是一回事，有最基本的热力学数据计算常识就能理解。H(0)和U(0)是相同的，H(T)和U(T)在理想气体近似下就相差个RT，这是平动部分贡献的，和振动没有任何关系，显然给H(T)-H(0)和给U(T)-U(0)用的频率校正因子完全是一码事。再次提醒，如果你缺乏热力学数据计算的常识知识，一定仔细看看Shermo程序手册的附录，搞清楚基本计算原理。顺带一提，相关中级量子化学教程（http://www.keinsci.com/KBQC）的“热力学量与能量相关性质的计算”一节对热力学数据计算的背景知识有超级详细的讲解，十分推荐想深入学习的人参加。
...
Capture.PNG (14.17 KB, 下载次数 Times of downloads: 258)

下载附件 Download



2020-5-24 20:39 上传 Uploaded
...
sob老师 发现了疑似一个BUG 无法正确得到自由能校正量  以下是输出文件[naonao5205@localhost done]$ Shermo CH4.log -sclZPE 0.9699

 Shermo: A general code for calculating molecular thermochemistry properties

 Version 2.0.1  Release date: 2020-May-20
...
              If this code is utilized in your work, PLEASE CITE:
 ...
 Scale factor of vibrational frequencies for ZPE:        0.9699
 ...
 Note: The electronic energy loaded from input file will be used

 Detecting point group...

 Point group has been successfully detected

 Warning: Rotational symmetry number cannot be identified for this point group



                       ======= Molecular information =======

 Electronic energy:      -40.45014800 a.u.
 ...
 Rotational symmetry number:  0

 Principal moments of inertia (amu*Bohr^2):

       11.547243       11.547249       11.547256

 Rotational constants relative to principal axes (GHz):

    156.291956    156.291877    156.291784

 Rotational temperatures (K):    7.500822    7.500819    7.500814
...
  1318.9  1318.9  1318.9  1538.8  1538.8  3052.9  3196.7  3196.7  3196.7
...
                          ========= Rotation ========
 ...
 Rotational q:         Infinity

 Rotational U:      3.718 kJ/mol      0.889 kcal/mol    =H

 Rotational S:   Infinity J/mol/K  Infinity cal/mol/K   -TS:Infinity kcal/mol
...
                          ======== Vibration ========
 ...
 Vibrational q(V=0):    1.006382E+000

 Vibrational q(bot):    2.416432E-021

 Vibrational U(T)-U(0):     0.104 kJ/mol     0.025 kcal/mol   =H(T)-H(0)

 Vibrational U:    114.258 kJ/mol     27.308 kcal/mol    =H

 Vibrational S:      0.400 J/mol/K     0.096 cal/mol/K   -TS:   0.029 kcal/mol

 Vibrational CV:     2.294 J/mol/K     0.548 cal/mol/K   =CP

 Zero-point energy (ZPE):    114.15 kJ/mol,     27.28 kcal/mol    0.043479 a.u.
...
                           ===========================
 ...
 Total CV:      27.238 J/mol/K       6.510 cal/mol/K

 Total CP:      35.552 J/mol/K       8.497 cal/mol/K

 Total S:     Infinity J/mol/K    Infinity cal/mol/K    -TS:  Infinity kcal/mol

 Thermal correction to U:    121.695 kJ/mol     29.086 kcal/mol   0.046351 a.u.

 Thermal correction to H:    124.174 kJ/mol     29.678 kcal/mol   0.047295 a.u.

 Thermal correction to G:  -Infinity kJ/mol  -Infinity kcal/mol  -Infinity a.u.

 Electronic energy:        -40.4501480 a.u.

 Sum of electronic energy and ZPE, namely U/H/G at 0 K:        -40.4066689 a.u.

 Sum of electronic energy and thermal correction to U:         -40.4037969 a.u.

 Sum of electronic energy and thermal correction to H:         -40.4028527 a.u.
...
(150.56 KB, 下载次数 Times of downloads: 3)



2021-4-27 21:58 上传 Uploaded
点击下载
Click to download
...
(284.27 KB, 下载次数 Times of downloads: 3)
...
   0 I    25.0000*   0   126.900   -1.789961   -0.021685   -0.000321

   1 O     8.0000    0    15.999    1.837129    0.032192    0.000396

* core charge reduced due to ECP复制代码
...
Shermo: A general code for calculating molecular thermochemistry properties
 ...
 Version 2.2  Release date: 2021-Jun-17 (last update: 2021-Jul-3)
...
              If this code is utilized in your work, PLEASE CITE:
 ...
 Shermo test.in -sclZPE 0.985 -ilowfreq 2
 ...
 Error: Unable to identify the program that generated this file, press ENTER button to exit复制代码
...
Clipboard01.png (71.02 KB, 下载次数 Times of downloads: 289)

下载附件 Download



2021-7-28 02:00 上传 Uploaded
...
(350.43 KB, 下载次数 Times of downloads: 2)



2021-7-28 16:11 上传 Uploaded
点击下载
Click to download
...
Clipboard01.png (151.82 KB, 下载次数 Times of downloads: 281)

下载附件 Download



2021-7-29 03:08 上传 Uploaded
...
实际上Shermo直接就提供了计算浓度改变导致的自由能变的功能，都省得自己手动算了，Shermo手册里有详述和计算公式。简单来说，你只要把settings.ini里的conc设为目标浓度即可。比如当前settings.ini里T=350、P=2，若你设conc= 1.5M，则Shermo运行后不仅会输出(350K,2atm)状态的自由能，还会输出delta-G of conc. change，这就是从当前(350K,2atm)状态转变为(350K,1.5M)状态的自由能变，之后输出的Gibbs free energy at specified concentration就是(350K,1.5M)状态的自由能。显然，若设T= 298.15且conc= 1M，最后Gibbs free energy at specified concentration给你的就是液相标准态自由能。此版本开始的Shermo还可以被molclus >=1.9.9.6版调用来计算热力学数据。
...
wilely 发表于 2024-10-12 15:07

我想计算质谱测试时复合物形成的热力学量，是在473k，真空下，我校正时压强P=0可以算吗？

压力不可能设0，此时没法算平动对热力学量的贡献，看Shermo手册附录里的计算公式便知
...
peter123 发表于 2025-5-7 15:51

想请教一下老师，我目前在进行溶液中150个原子的有机分子笼和酸根阴离子体系的弱相互作用（C-H...O氢键）分 ...

已经解决了，我把路径前后的双引号删除了以后就可以分析了

### 105 楼

本帖最后由 陈AG 于 2026-3-9 14:24 编辑 



sob老师，对柔性分子做构型搜索后，我选用十个能量最低的构型做opt freq ，然后再提高精度计算，然后通过4.2.3的例子就可以得到构型熵吗，得到的构型熵是文献定义的一样吗In-situ entropic ligand engineering enables high-efficiency quantum dot solar cells | Nature Communications

### 106 楼

陈AG 发表于 2026-3-9 14:14

sob老师，对柔性分子做构型搜索后，我选用十个能量最低的构型做opt freq ，然后再提高精度计算，然后通过4. ...
...
Shermo手册附录里直接给了构象熵的计算公式，手册里也明确给了构象熵的计算例子，手册里搜conformation entropy

### 107 楼

Shermo今日在官网http://sobereva.com/soft/shermo上更新了2.6.2版，解决了Gaussian输入文件里opt=calcall与freq关键词联用时Shermo会把两个子任务输出的振动频率全都载入的bug。

## 入库完整性评估

- 图片处理：本地保留 2 张附件图，并在下方集中列出；未逐一重定位到具体楼层。
...
![17494 附件图 1](images/img_1.png)

![17494 附件图 2](images/img_2.jpg)
