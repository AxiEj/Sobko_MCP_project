---
thread_id: 58922
source_id: forum_thread:58922
title: "化学体系的静电势的计算和分析方法汇总"
url: http://bbs.keinsci.com/thread-58922-1-1.html
...
source_crawled_at: "2026-06-05T08:45:06.846Z"
...
authority_level: B
confidence: 0.97
classification_reason: sobereva原创静电势计算与分析汇总，综述化学体系中静电势的各种计算和分析方法。
---

# 化学体系的静电势的计算和分析方法汇总

- 原帖 URL：<http://bbs.keinsci.com/thread-58922-1-1.html>
- 论坛板块：波函数分析与Multiwfn
- 作者：**sobereva**
- 浏览量：3110 | 回复数：2 | 共1页
- 完整性：**全部内容已完整抓取**。
...
注意本文内容并不是对静电势本身以及分析方法做详细具体的介绍，而只是提供一个索引和相关资料的整合、概述，包含大量我之前写过的静电势相关博文的链接。在笔者讲授的“量子化学波函数分析与Multiwfn程序培训班”（http://www.keinsci.com/WFN）里面有关于静电势的最为完整、系统、深入的讲解，从基本定义开始把各种相关知识串起来非常细致地讲，涉及到巨量图片，并且给出十分丰富的计算实例，还讲了很多重要经验和要点，本文涉及的所有分析也都包括在内，因此极为适合希望从头一次性把静电势分析学习得特别通透、毫无遗漏的人参加。
...
功函数和偶极校正和当前主题没多少关系，北京科音的CP2K培训里专门讲了这两个概念和用法



## 图片附件

![58922 image img_1.png](images/img_1.png)

![58922 image img_2.png](images/img_2.png)

![58922 image img_3.png](images/img_3.png)

![58922 image img_4.png](images/img_4.png)

![58922 image img_5.png](images/img_5.png)

![58922 image img_6.png](images/img_6.png)

![58922 image img_7.jpg](images/img_7.jpg)

![58922 image img_8.png](images/img_8.png)

![58922 image img_9.png](images/img_9.png)

![58922 image img_13.png](images/img_13.png)

![58922 image img_15.png](images/img_15.png)

![58922 image img_16.png](images/img_16.png)
