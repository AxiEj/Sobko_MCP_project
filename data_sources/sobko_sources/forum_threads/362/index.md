---
thread_id: 362
source_id: forum_thread:362
title: "AIM学习资料和重要文献合集"
url: http://bbs.keinsci.com/thread-362-1-1.html
...
source_crawled_at: "2026-06-05T08:53:40.668Z"
original_reply_count: 22
page_count: 2
views: 68803
software_tags:
- Multiwfn
...
authority_level: A
confidence: 0.97
classification_reason: sobereva整理的AIM学习资料和重要文献合集，6.8万浏览。
---

# AIM学习资料和重要文献合集

- 原帖 URL：<http://bbs.keinsci.com/thread-362-1-1.html>
- 论坛板块：波函数分析与Multiwfn
- 作者：**sobereva**
- 浏览量：68803 | 回复数：22 | 共2页
- 完整性：**全部内容已完整抓取**。
...
为方便大家学习如今已经被广为使用的、十分流行的波函数分析理论AIM（Atoms-in-Molecules）的理论知识，在此将有价值的AIM学习资料，包括重要AIM文献、综述整理到一起，下载地址：http://pan.baidu.com/s/1pJqgOsz



Multiwfn是极强大、非常灵活、使用特别广泛的做AIM分析的程序，官网见http://sobereva.com/multiwfn，可免费下载。相关常识看《Multiwfn FAQ》（http://sobereva.com/452）
...
压缩包里“与AIM相关的有意义的文献和一些方法的原文”这个文件夹里是一些AIM领域方面的原文，以及一些笔者认为比较重要、有普遍意义的文献。文件名开头注明了文章主要内容。包含以下文件：
...
Atoms in molecules as non-overlapping, bounded, space-filling open quantum systems.pdf

(816.97 KB, 下载次数 Times of downloads: 695)



2015-2-13 13:56 上传 Uploaded
点击下载
Click to download
...
除以上压缩包里的内容外，以下这些文章强烈建议阅读！读了你就知道用AIM理论都能做什么、具体怎么实现



Multiwfn支持的分析化学键的方法一览（其中详细介绍了利用AIM分析都能如何研究化学键问题）

http://sobereva.com/471

幻灯片：Multiwfn与波函数分析简介（里面有一些AIM基本知识介绍和例子）

http://sobereva.com/239

使用Multiwfn做拓扑分析以及计算孤对电子角度 （AIM分析主要组成部分是拓扑分析和盆分析。此帖详细介绍了AIM拓扑分析在Multiwfn中的操作。也可以看手册4.2.1节的例子，以及3.14节的相关理论和算法介绍）

http://sobereva.com/108

使用Multiwfn+VMD快速地绘制高质量AIM拓扑分析图（含视频演示。看了就知道如果结合VMD，可以让Multiwfn的AIM拓扑分析更强大，图像效果更漂亮，考察临界点性质更方便）

http://sobereva.com/445

Multiwfn结合VMD绘制AIM拓扑分析图（详细介绍如何手动把Multiwfn的AIM拓扑分析结果导出然后在VMD里显示。看过上面这篇就没必要看这篇了）
...
利用约化密度梯度考察AIM临界点的位置（此文介绍的方法可以帮助你判断什么地方应该有AIM临界点，以及帮助你理解为什么有时候你自己觉得应该有临界点的地方却找不到临界点）

http://sobereva.com/267

透彻认识氢键本质、简单可靠地估计氢键强度：一篇2019年JCC上的重要研究文章介绍（提出了新的通过AIM分析准确预测氢键键能的方法，极为重要！）

http://sobereva.com/513（http://bbs.keinsci.com/thread-14600-1-1.html）

计算分子内氢键键能的几种方法（通过实例讲解如何通过Multiwfn做AIM分析预测内氢键键能）

http://sobereva.com/522（http://bbs.keinsci.com/thread-15496-1-1.html）
...
AIM盆分析一般就是指对电子密度做盆分析。对于做AIM盆分析，建议看Multiwfn手册4.17.1节的例子，以及3.20节的理论介绍。也建议看下文的介绍
...
O(∩_∩)O谢谢，好东西，正好需要，楼主辛苦了

### 8 楼

感谢sob老师，最近一段正在找AIM相关资料，辛苦了。
...
请问老师：周期性体系的AIM计算该怎么做？有现成的程序可以用吗？谢谢

### 12 楼

pyscf 发表于 2018-9-6 03:52

请问老师：周期性体系的AIM计算该怎么做？有现成的程序可以用吗？谢谢

有一些程序，诸如critic2之类，反正都不好用



2021-Feb-28补充：从2021年2月更新的Multiwfn开始，Multiwfn已经可以完美地基于CP2K产生的molden文件做AIM拓扑分析了。完全没必要用critic2了。输入文件同《使用Multiwfn结合CP2K通过NCI和IGM方法图形化考察固体和表面的弱相互作用》（http://sobereva.com/588）所说的一样，操作和对孤立体系分析时完全一样

### 13 楼

sobereva 发表于 2018-9-6 04:04
...
老师您好，我刚了解到这个软件，请问VASP得到的输出文件能用于AIM分析吗

### 20 楼

泡泡鱼1218 发表于 2024-11-6 21:43
...
周期性体系的AIM分析，一般建议Multiwfn结合CP2K产生的波函数文件。j基于VASP产生的CHGCAR也不是不能做，上文说了，但功能有限制

### 21 楼

老师，我想请问一下一般什么情况有必要用AIM分析呢，我看过您写的帖子，感觉虽然AIM理论比较明确，但实际化学意义并不是很明确，我这个月看了不少金属以及非金属团簇以及组成的主客体分子一些文献，判断相互作用以及之间的成键强弱许多都是AIM拓扑分析，有的也搭配RDG分析，并且感觉实际分析也并不是很明确得到某些规律，那我就是想问一下，一般什么情况下有必要做AIM分析呀，如果分析成键做 Mayer键级不更好嘛，并且我看到许多过渡金属团簇之间成键以及周期性体系原子电荷都是用的是AIM分析，一般有没有这个必要呀。一般分析分子片段间相互作用一般就直接用IRI和ELF可行不，或者在加一个AICD电流来判断芳香性。

### 22 楼

cyh时代 发表于 2025-12-1 19:29
...
sobereva 发表于 2025-12-4 10:32

成键分析有非常多的方式，AIM分析框架下能得到很多独有的信息，这不是几句话能说清楚的，在量子化学波函 ...

好的谢谢老师，之前听您说过AIM电荷等一些分析化学意义并不明确，以及现在做弱相互作用分析都用IRI aIGMH等一些图形化展示，所以一般我就没怎么用，也没打算深入学习这个，但最近看文献许多做键级分析以及相互作用分析都在用AIM拓扑分析，并且还以这个为主，所以才打算把这个重视一下，后面我好好看看关于AIM这一部分的内容。
