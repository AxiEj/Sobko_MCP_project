---
thread_id: 2413
source_id: forum_thread:2413
title: 'Gaussian中用TDDFT计算激发态和吸收、荧光、磷光光谱的方法'
url: http://bbs.keinsci.com/thread-2413-1-1.html
date: '2015-12-22T16:34:09+08:00'
source_type: forum_thread
coverage: browser_verified_full_thread_text
source_provider: wsl2_chrome_cdp_verified_session
source_crawled_at: '2026-06-05T16:20:00+08:00'
original_reply_count: 216
page_count: 15
views: 400862
software_tags:
- Gaussian
...
authority_level: A
confidence: 0.99
classification_reason: sobereva原创TDDFT激发态计算权威指南，40万浏览，详细讲解吸收/荧光/磷光光谱计算方法和常见问题，量子化学版核心置顶参考资源。
---

# Gaussian中用TDDFT计算激发态和吸收、荧光、磷光光谱的方法

- 原帖 URL：<http://bbs.keinsci.com/thread-2413-1-1.html>
- 论坛板块：量子化学 (Quantum Chemistry)
- 作者：**sobereva**（公社社长，管理员）
- 发布日期：2015-12-22，更新至2024年
- 浏览量：400,862 | 回复数：216 | 共15页
- 完整性：**全部15页共217条楼层正文已完整抓取**。

## 核心结论

本文系统讲解使用Gaussian和TDDFT计算各类电子激发态相关光谱的方法，包括吸收光谱、荧光发射光谱、磷光发射光谱，覆盖气相和溶液环境下的计算流程。
...
文/Sobereva @北京科音First release: 2015-Dec-22   Last update: 2024-Feb-19

1 前言



含时密度泛函理论（TDDFT）是当下最主流的电子激发问题的计算方法。本文专门介绍一下怎么用最流行的量子化学程序Gaussian做TDDFT计算得到电子激发相关的信息，以及结合Multiwfn程序得到电子吸收、荧光、磷光光谱。限于篇幅和笔者的时间，本文不可能把原理讲得很细，但只要理解本文介绍的基本原理，严格follow本文的例子，对自己研究的体系正确做计算一般是不成问题的。如果想完整、全面、系统学习电子激发相关的理论背景知识和对各种实际问题的计算方法，非常推荐零基础初学者们参加我讲授的相关初级量子化学教程（[已省略培训课程链接]），对于已经有一定基础的人非常推荐参加讲得明显更深入、传授更多经验技巧的相关中级量子化学教程（[已省略培训课程链接]），教程中有针对不同问题研究的巨量实例，讲的东西远远比本文多。另外在相关 CP2K 第一性原理教程（[已省略培训课程链接]）里我还会着重讲授用强大、免费、高效的第一性原理程序CP2K通过TDDFT做周期性体系电子激发研究的方法。
...
1.png (33.41 KB, 下载次数 Times of downloads: 1082)

下载附件 Download



2024-12-4 21:07 上传 Uploaded
...
file:///C:\Users\Administrator\AppData\Roaming\Tencent\Users\178815188\QQ\WinTemp\RichOle\XFMX7J%UXDTL0]IBK2O{BGF.png
...
36YS77W~ZBYC}CBJ$MH}0CX.png (19.72 KB, 下载次数 Times of downloads: 926)

下载附件 Download


水中激发态优化
2015-12-26 16:17 上传 Uploaded
...
XFMX7J%UXDTL0]IBK2O{BGF.png (17.59 KB, 下载次数 Times of downloads: 877)
...
QQ图片20140315080428.jpg (27.27 KB, 下载次数 Times of downloads: 866)

下载附件 Download



2015-12-26 16:24 上传 Uploaded
...
sob老师您好，我想请问一下4.3 气相下计算T1结构和磷光发射能中的方法一中的2 取上一步优化得到的结构，用# B3LYP/6-31G* TD(triplet)，电荷和自旋多重度为0 1。第一激发态的激发能就是磷光发射能了。这一步，是否需要加上opt参数做TDDFT计算？若我这么做了，得到T1的结果，和自旋多重度0 3优化得到的结果有什么区别呢？我这里搞不懂了，还请老师解答。
...
sobereva 发表于 2018-11-20 11:11

TD(triplet)结合0 1优化，以及直接用0 3优化，都可以得到T1的结构，后者速度快得多，原理上也更好（结果 ...

谢谢老师回答。

### 102 楼

sob老师好，我想知道我在算紫外吸收谱图的时候第一步用了opt+freq，这样会有影响吗？还是必须只用opt?

### 103 楼

shiyanan 发表于 2019-1-17 20:08

sob老师好，我想知道我在算紫外吸收谱图的时候第一步用了opt+freq，这样会有影响吗？还是必须只用opt?

问题不确切，你都没说具体怎么得到UV-Vis图。

如果从S0结构开始做激发态的opt freq，利用第一步输出的激发能、振子强度信息可以绘制吸收光谱图。

### 104 楼

sobereva 发表于 2019-1-18 00:15

问题不确切，你都没说具体怎么得到UV-Vis图。

如果从S0结构开始做激发态的opt freq，利用第一步输出的激 ...

不好意思老师，没表述清楚。想问下面的这两部路径正确吗？

第一步：# PBE1PBE/6-311G* opt freq scrf=solvent=ethanol



第二步：# PBE1PBE/6-311G* TD(nstates=20)  scrf=solvent=ethanol

### 105 楼

shiyanan 发表于 2019-1-18 08:55

不好意思老师，没表述清楚。想问下面的这两部路径正确吗？

第一步：# PBE1PBE/6-311G* opt freq scrf=so ...
...
老师那个我懂了，就是想知道第一步路径 #P PBE1PBE/6-311G* opt scrf=solvent=ethanol 用#P PBE1PBE/6-311G* opt freq scrf=solvent=ethanol算会不会有影响？麻烦老师了

### 107 楼

shiyanan 发表于 2019-1-18 14:30

老师那个我懂了，就是想知道第一步路径 #P PBE1PBE/6-311G* opt scrf=solvent=ethanol 用#P PBE1PBE/6-31 ...

得到的优化出来的结构都一样

### 108 楼

sobereva 发表于 2019-1-18 19:27
...
老师，您好，我做吸收光谱时同一个基态结构，设nstates=40，得到的Excited State   1: 357.59 nm  f=0.0181; Excited State  14: 265.33 nm  f=1.0463,我想问一下那吸收波长究竟是多少呢？我疑惑的是一般吸收波长对应的是Excited State   1 波长？然而他的 f却很小，所以不清楚该取哪个值了

### 110 楼

墨迹遇见 发表于 2019-1-30 11:07

老师，您好，我做吸收光谱时同一个基态结构，设nstates=40，得到的Excited State   1: 357.59 nm  f=0.0181 ...

绘制出来理论光谱，Multiwfn可以直接把谱峰最大点位置给你找出来，仔细看
...
老师，用Multiwfn怎样调节FWHM值呢？谢谢

### 112 楼

墨迹遇见 发表于 2019-2-15 22:48
...
老师您好，请问我在shelxtl中解完晶体后导出的文件在计算荧光磷光发射能时还要不要进行优化，如果要优化的话对它的构型影响大吗？

### 114 楼

hanmingxi 发表于 2019-5-15 15:12

老师您好，请问我在shelxtl中解完晶体后导出的文件在计算荧光磷光发射能时还要不要进行优化，如果要优化的 ...

至少氢原子位置需要重新优化。

如果你就是要模拟晶体结构的情况，重原子位置不需要优化。
...
Sob老师，您好，如果基态是开壳层，以上方法还适用吗？在算激发态寿命时有没有需要注意的地方？

### 117 楼

DUNING 发表于 2020-3-31 11:14
...
请问Sob老师是否有关于用TDDFT计算三重态时需要设置mult=1的文献或书籍，我个人比较相信sob的，但我各个导师都要我用mult=3，我却无法明确反驳，他们不懂中文，不然我就把你帖子给他们看了

### 119 楼

clayer 发表于 2020-6-29 04:15

请问Sob老师是否有关于用TDDFT计算三重态时需要设置mult=1的文献或书籍，我个人比较相信sob的，但我各个导 ...

这都是TDDFT基本常识和计算程序基本计算原理问题

你把0 3和TD一起用，SCF过程算出来的就是你实际上要的T1，你再基于这个T1波函数进一步以TDDFT算激发态，怎么可能得到的还是T1？显然只能得到其它态

你导师不信的话让他写邮件问Gaussian官方客服。

### 120 楼

本帖最后由 clayer 于 2020-6-30 07:51 编辑 

sobereva 发表于 2020-6-29 14:02

这都是TDDFT基本常识和计算程序基本计算原理问题

你把0 3和TD一起用，SCF过程算出来的就是你实际上要的T ...

哈哈，感谢sob，下次他们再问我，我就让他们去问gaussian客服。
...
Clipboard01.png (109.73 KB, 下载次数 Times of downloads: 221)

下载附件 Download



2020-10-21 12:26 上传 Uploaded
...
202107070847171451..png (8.64 KB, 下载次数 Times of downloads: 123)

下载附件 Download



2021-7-7 08:47 上传 Uploaded
...
202107070848174099..png (12.99 KB, 下载次数 Times of downloads: 136)

下载附件 Download



2021-7-7 08:48 上传 Uploaded
...
不要写test、 direct这些毫无意义的关键词。我博文里没有提到的关键词如果你不十分清楚有什么意义一律不要写
...
老师，在进行激发能计算时，我想只计算S10-S20之间的态，输入关键词后显示不正确，# PBE1PBE/6-311G* TD(nstates=10-20) ，想请问老师应该对哪里进行修正，还是高斯计算时只能从第一个态开始
...
1.png (43.65 KB, 下载次数 Times of downloads: 89)

下载附件 Download


1
2022-3-25 22:09 上传 Uploaded
...
2.png (20.31 KB, 下载次数 Times of downloads: 81)

下载附件 Download


2
2022-3-25 22:10 上传 Uploaded
...
3.png (102.26 KB, 下载次数 Times of downloads: 99)

下载附件 Download



2022-3-25 22:12 上传 Uploaded
...
本帖最后由 wzkchem5 于 2022-4-19 14:27 编辑 
...
本帖最后由 LittleLian 于 2022-4-20 17:30 编辑 



sob老师您好   我在用UDFT方式优化T1的时候，采用了B3LYP的方法 输入文件设置的是default spin但是第一步计算以后 输出文件变成了unrestricted 即显示的是UB3LYP,在进行第二步计算的时候 需要把他重新改回default spin吗

### 182 楼

LittleLian 发表于 2022-4-20 10:28

sob老师您好   我在用UDFT方式优化T1的时候，采用了B3LYP的方法 输入文件设置的是default spin但是第一步计 ...

你指的是算S0吗？

当且仅当T1结构下的单重态波函数稳定时，可以改。如果该改但是没有改，结果也是可用的，只不过浪费一些计算时间

### 183 楼

LittleLian 发表于 2022-4-20 17:28

sob老师您好   我在用UDFT方式优化T1的时候，采用了B3LYP的方法 输入文件设置的是default spin但是第一步计 ...

怀疑你在用GaussView的Calculation setup产生输入文件，因此说出一些莫名其妙的描述

绝对不要用那个东西

### 184 楼

sobereva 发表于 2022-4-21 06:14

怀疑你在用GaussView的Calculation setup产生输入文件，因此说出一些莫名其妙的描述

绝对不要用那个东西

啊sob老师我真的是用Gauss view 的calculation这么操作的...因为第一次接触量化计算，很多都不懂，所以说的话奇奇怪怪 很抱歉   那如果不这么设置的话 我要如何得到输入文件呢，因为我是从b站上学的这么操作..

### 185 楼

LittleLian 发表于 2022-4-21 08:12

啊sob老师我真的是用Gauss view 的calculation这么操作的...因为第一次接触量化计算，很多都不懂，所以说 ...

用文本编辑器（比如记事本，最好用vim、Notepad++等专业编辑软件，不要用Word）写，如果不知道某些关键词怎么写，参照高斯官网或者高斯手册。

用GaussView产生输入文件可以作为入门手段，但是正式计算不要用

### 186 楼

LittleLian 发表于 2022-4-21 15:12

啊sob老师我真的是用Gauss view 的calculation这么操作的...因为第一次接触量化计算，很多都不懂，所以说 ...

少看B站上的一些乌七八糟的东西，很多东西都严重误人子弟，讲授者自己还没怎么入门就给别人瞎讲。之前随便看过上面的一些视频，真是槽点无数，诸如居然能把输出文件里的跃迁偶极矩当成是偶极矩...
...
sob老师这里的pbe1pbe关键词是方法吗 能改为b3lyp吗

### 188 楼

LittleLian 发表于 2022-4-29 12:41

sob老师这里的pbe1pbe关键词是方法吗 能改为b3lyp吗

是泛函

仔细看http://sobereva.com/272了解什么时候用PBE1PBE，什么时候用B3LYP，什么时候两者都可以用，什么时候两者都不能用

### 189 楼

wzkchem5 发表于 2022-4-29 20:01

是泛函

仔细看http://sobereva.com/272了解什么时候用PBE1PBE，什么时候用B3LYP，什么时候两者都可以用 ...

谢谢老师 老师我还有一个问题 就是如果算一半计算机需要关机了 续算 是不是在Gaussian界面加上关键词geom=check,然后把最下面原子坐标都删了就可以

### 190 楼

LittleLian 发表于 2022-4-29 14:49

谢谢老师 老师我还有一个问题 就是如果算一半计算机需要关机了 续算 是不是在Gaussian界面加上关键词geom ...

当且仅当你做的是结构优化的时候可以

### 191 楼

wzkchem5 发表于 2022-4-29 22:09

当且仅当你做的是结构优化的时候可以

那如果在做上述的激发态能量的计算的时候呢

### 192 楼

LittleLian 发表于 2022-4-29 15:30

那如果在做上述的激发态能量的计算的时候呢

优化激发态结构的时候可以用geom=check，算激发能的时候只能读波函数，读结构虽然也不算错，但是对于减少重复计算没有任何帮助

### 193 楼

wzkchem5 发表于 2022-4-29 22:57

优化激发态结构的时候可以用geom=check，算激发能的时候只能读波函数，读结构虽然也不算错，但是对于减少 ...

老师请问读取波函数是写入guess=read吗 因为我这个断断续续算了三天了还没算完

### 194 楼

LittleLian 发表于 2022-5-2 12:19
...
老师您好，请教一个问题。我考察的是电荷转移激发态，在基于特定态的溶剂模型下得到了它的垂直发射能。如果我还想进一步对它进行空穴-电子分析，是不是也是用基于特定态的溶剂模型更加准确呢？而这个过程是不是可以直接在4.5中的（4）第一步中：“ 第一步：在(3)得到的结构下，获得平衡溶剂下的激发态能量，并将激发态溶剂信息写入chk：

# PBE1PBE/6-311G* TD scrf(externaliteration,read,solvent=ethanol)，末尾空一行写noneq=write

激发态能量应当取末尾输出的After PCM corrections后面的能量值。” 加入density=current和iop（9/40=4）关键词来实现呢？

### 196 楼

zlp 发表于 2022-6-7 10:16

老师您好，请教一个问题。我考察的是电荷转移激发态，在基于特定态的溶剂模型下得到了它的垂直发射能。如果 ...
...
请问老师，Gaussian计算荧光不考虑悬轨耦合，会不会遭到质疑？

### 198 楼

Flynn 发表于 2022-6-21 09:00

请问老师，Gaussian计算荧光不考虑悬轨耦合，会不会遭到质疑？

取决于体系和你需要计算的量。

如果你指的是荧光激发/发射波长、发射峰形、振子强度、荧光发射速率常数的话，当所有原子都是前3周期元素时不会被质疑，第4周期未必，第5周期及以后容易被质疑。

如果你指的是荧光量子产率的话，在以上条件的基础上，还需要你能证明ISC可以忽略，才能不被质疑。

### 199 楼

sobereva 发表于 2015-12-23 07:14

谢谢，笔误已更正

老师您好，请问这个激发态寿命是如何推导出来的? 我看有人说在Hideo Okabe的Photochemistry of Small Molecules里有写，但我并未找到...

### 200 楼

Flynn 发表于 2022-7-18 10:10

老师您好，请问这个激发态寿命是如何推导出来的? 我看有人说在Hideo Okabe的Photochemistry of Small Mol ...

http://bbs.keinsci.com/thread-15075-1-1.html

### 201 楼

卢老师，请问您：我在计算二聚体的吸收光谱时，光谱相比与单个分子有红移和振子强度降低。我现在想解释这个现象，我的思路是找到吸收光谱主要贡献几个态的的轨道所处的原子片段，通过分子间弱相互作用判断对片段上电荷的具体作用是什么，在已知几个态的激发特征的前提下，对片段电荷的吸引或排斥作用进行分析，说明限制/促进激发的原因来解释红移现象，您看可以吗？

### 202 楼

上善若水 发表于 2022-7-24 09:27

卢老师，请问您：我在计算二聚体的吸收光谱时，光谱相比与单个分子有红移和振子强度降低。我现在想解释这个 ...

可以试一下，但是很可能实验现象不是电荷导致的，而是两个分子的激发态发生线性组合导致的，那样的话靠电荷是分析不出来的。

### 203 楼

上善若水 发表于 2022-7-24 16:27

卢老师，请问您：我在计算二聚体的吸收光谱时，光谱相比与单个分子有红移和振子强度降低。我现在想解释这个 ...

应当看看单体和二聚体的电子激发特征的差异，比如二聚体时是否空穴/电子是在复合物上离域的而非定域在单分子上的
...
老师您好，我想计算S1到T1的激发能，不知道如下计算过程是否正确

1 基态几何优化：#P B3LYP/def2tzvp opt 

2 取上一步优化得到的结构，做S1态优化：#P B3LYP/def2tzvp opt TD 最后一次输出的第一激发态的激发能记为A

然后：

1 优化T1结构：#P B3LYP/def2tzvp opt ，电荷和自旋多重度为0 3。

2 取上一步优化得到的结构，用#P B3LYP/def2tzvp TD(triplet)，电荷和自旋多重度为0 1。第一激发态的激发能为B。用B-A就是S1→T1的能量

### 206 楼

七尺贱 发表于 2023-2-20 12:26
...
七尺贱 发表于 2023-2-21 10:00

绝热

要取的是程序输出的相应激发态能量，用这个来求差，而不是激发能来求差

### 209 楼

sobereva 发表于 2023-2-22 05:39
...
老师您好，想请教下，做ECD计算能量优化阶段关键词这样可以吗？#p b3lyp/6-31g(d) TD(nstates=10) scrf=(solvent=methanol) geom=connectivity density out=wfn

您说的在末尾加上wfn的输出位置是必需要加的吗？一般什么格式呢？还是直接写就好

### 211 楼

farrah 发表于 2023-5-9 14:25

老师您好，想请教下，做ECD计算能量优化阶段关键词这样可以吗？#p b3lyp/6-31g(d) TD(nstates=10) scrf=(so ...

我不知道你当前的任务目的何在，也不知道你说的“能量优化”指什么

对于算ECD，density完全没必要写，也不需要输出wfn文件。需要写什么下文的例子都体现得很清楚了
...
dlldwtz 发表于 2023-8-15 09:03

请问老师，利用casscf+mrci计算激发态的时候，为了得到最低三个态的能量，需要像tddft一样多设置几个态吗？ ...

有一定的必要性，但是在多参考态计算里面，往往更重要的是保持空间对称性。参见http://bbs.keinsci.com/forum.php ... 0&fromuid=21811
...
dansor1 发表于 2024-10-21 22:52

请教一下各位老师，含氮有机物体系，总电子数为奇数，基态自旋多重度为2，如何对其激发态及SOC进行计算

直接基于UKS参考态按下文照常算，或者ORCA用DFT/ROCIS算（此时激发态无自旋污染）
...
虎王 发表于 2024-12-25 18:03

以UDFT得到T1态极小值点结构，然后以TDDFT计算垂直跃迁能，原则上应更接近实际的磷光过程，毕竟符合弗兰克- ...

垂直和绝热都不是严格的过程，严格和实验对比需要考虑振动耦合



为了简化研究，必须用垂直发射能的话，就用Franck-Condon定理以及基于其计算的磷光发射能的相关文章（google学术一搜一堆）怼回去
