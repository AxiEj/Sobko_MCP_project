...
另外，关于这些分析方法的原理、细节、特点以及在Multiwfn中的使用技巧，笔者会在北京科音每年都举办的“量子化学波函数分析与Multiwfn程序培训班”（http://www.keinsci.com/workshop/WFN_content.html）里非常深入、系统、全面地教授，并给出大量实际例子，十分推荐大家参加。读者还可以下载http://sobereva.com/167里提到的迄今用Multiwfn发表的海量论文的pdf合集，本文提到的大多数研究方法都已被其中的很多文章利用，可以将这里面的文章当例子库用。
