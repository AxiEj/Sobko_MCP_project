...
读者请使用2021年3月4日及以后更新的Multiwfn版本，否则有的地方和本文所述不符。Multiwfn可以在http://sobereva.com/multiwfn免费下载。本文用的VMD是1.9.3版，可以在http://www.ks.uiuc.edu/Research/vmd/免费下载。本文的例子是北京科音分子动力学与GROMACS培训班（http://www.keinsci.com/workshop/KGMX_content.html）中我讲蛋白质-配体复合物模拟的3ATL那个例子，此体系结构如下
